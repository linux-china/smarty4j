...
public class Cache<K, V> implements Map<K, V> {
    ...
    */
    ...
    public synchronized Collection<V> values() {
        ...
        return Collections
                .unmodifiableCollection(new AbstractCollection<V>() {
                    Collection<CacheObject<V>> values = map.values();

                    public Iterator<V> iterator() {
                        return new Iterator<V>() {
                            Iterator<CacheObject<V>> it = values
                                    .iterator();
    ...
    public synchronized Set<Map.Entry<K, V>> entrySet() {
        ...
        return new AbstractSet<Map.Entry<K, V>>() {
            private final Set<Map.Entry<K, CacheObject<V>>> set = map
                    .entrySet();

            public Iterator<Entry<K, V>> iterator() {
                return new Iterator<Entry<K, V>>() {
                    private final Iterator<Entry<K, CacheObject<V>>> it = set
                            .iterator();
    ...
    private static class LinkedList {
         ...
         */
        private LinkedListNode head = new LinkedListNode("head", null,
                null);
     ...
     */
    public abstract class AbstractMapEntry<K, V> extends
            AbstractKeyValue<K, V> implements Map.Entry<K, V> {
